	    ...
	    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
	      ...
	      <sf:form method="get" action="${base }/admin/order">
				...
				<div class="d-flex flex-row justify-content-between mt-4">
						...
						<select class="form-control" name="orderStatus" id="orderStatus" style="margin-right: 5px;">
								...
								<div id="myModal${count }" class="modal">
								  ...
								  <div class="modal-content">
								    ...
								    <div class="modal-body">
								      <p>Do you want to cancel with id ${order.id } ?</p>
								      
								    </div>
								    <div class="modal-footer">
								      <button type="button" class="btn btn-secondary" onclick="CloseModal(${count})" id="cancel">Cancel</button>
								      <button type="button" class="btn btn-primary" onclick="CancelOrder(${order.id})">Accept!</button>
								    </div>
								  </div>
